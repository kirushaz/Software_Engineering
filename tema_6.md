...
print('Список получился такой', list(x_value))
print()
print('Кортеж получился такой', tuple(x_value))
```
### Результат.
![Меню](pic6/lab6_1.png)
## Выводы

Создал список и кортеж.
...
Удалил элемент из кортежа с помощью преобразования его в список.
...
Я преобразовал кортеж к списку, затем проитерироваться по нему и записал все необходимые значения. 
...
Написал программу поиск значения больше 10 из кортежа.
